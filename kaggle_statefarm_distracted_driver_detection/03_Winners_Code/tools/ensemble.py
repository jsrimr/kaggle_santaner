...
resnet50_test1 = pd.read_csv('rsc/ensemble/resnet50.v2.csv', index_col=-1).values
vgg19_test = pd.read_csv('rsc/ensemble/vgg19.csv', index_col=-1).values
vgg19_test1 = pd.read_csv('rsc/ensemble/vgg19.v2.csv', index_col=-1).values
vgg16_test = pd.read_csv('rsc/ensemble/vgg16.csv', index_col=-1).values
vgg16_test1 = pd.read_csv('rsc/ensemble/vgg16.v2.csv', index_col=-1).values

ensemble = resnet50_test * resnet_weight + \
        resnet50_test1 * resnet_weight + \
        vgg19_test * vgg19_weight + \
        vgg19_test1 * vgg19_weight + \
        vgg16_test * vgg16_weight + \
        vgg16_test1 * vgg16_weight
